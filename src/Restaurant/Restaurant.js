...
function Load(){
  $(document).ready(function(){
    ...
    createCookie('currentpage','restaurant',null,30);
...
function Save(){
  ...
  IdParent = (IdParent==''||IdParent==null?0:IdParent);
  alert(IdParent);
  ...
  postTransactionEmpty(settings.endpoints.restaurant.POST,userentry,LoadRestaurant,'Restaurant was saved successfully!');
...
function Delete(id){
  ...
  postTransactionEmpty(settings.endpoints.restaurant.PUT,userentry,LoadRestaurant,'Restaurant was updated sucessfully!');

}


function LoadRestaurant(filter){ 
  getTransactionFilter(settings.endpoints.restaurant.GET,LoadPageDetail,filter);
}
...
function Restaurant() {
  ...
  return (
    <div>
        <br/>
        <h3 data-key="CLIENT" class="keycontainer" >Restaurants</h3>
        <div class="row" >
          <div class="col-sm-4" >
          ...
          <div class="col-sm-4" >
            <span  data-key="PARENT" class="keycontainer"  >Parent</span>
            <select id="IdParent" class="form-control c100"  >
